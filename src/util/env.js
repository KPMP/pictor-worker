...
module.exports.LOG_UNMAPPED_ROLLUP_BARCODE_FILE = process.env.LOG_UNMAPPED_ROLLUP_BARCODE_FILE || 'BarcodesUnmappedToRollup.txt';
module.exports.LOG_UNMAPPED_ROLLUP_BARCODE_HEADER = process.env.LOG_UNMAPPED_ROLLUP_BARCODE_HEADER || 'unmapped_barcode';
